...
if ($action == 'create_invoice'){
	...
	foreach($_POST['invoice_product'] as $key => $value) {
		...
		$item_color_front = $_POST['invoice_color_front'][$key];
		$item_color_front = $_POST['invoice_color_back'][$key];
		$item_door_skin = $_POST['invoice_door_skin'][$key];
		$item_order_height = $_POST['invoice_door_skin'][$key];
		$item_order_width = $_POST['invoice_door_skin'][$key];
		$item_billing_height = $_POST['invoice_door_skin'][$key];
		$item_billing_width = $_POST['invoice_door_skin'][$key];
