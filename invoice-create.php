				...
				<table class="table table-bordered table-hover table-striped" id="invoice_table" width="1500">
					...
					<tbody>
						<tr>
							...
							<td class="text-right">
								<div class="form-group form-group-sm no-margin-bottom">
									<input type="text" class="form-control color" name="invoice_color_front[]" value="Black">
								</div>
							</td>
							<td class="text-right">
								<div class="form-group form-group-sm no-margin-bottom">
									<input type="text" class="form-control color" name="invoice_color_back[]" value="Black">
								</div>
							</td>
							<td class="text-right">
								<div class="form-group form-group-sm no-margin-bottom">
							...
							<td class="text-right">
								<div class="form-group form-group-sm no-margin-bottom">
									<input type="text" class="form-control invoice_product_qty calculate " name="invoice_product_qty[]" value="0">
