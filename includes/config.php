...
define('COMPANY_NAME','DAAV');
define('COMPANY_ADDRESS_1','Near Power House more');
define('COMPANY_ADDRESS_2','Dubrajpur, Birbhum, West Bengal');
define('COMPANY_ADDRESS_3','India');
define('COMPANY_COUNTY','IND');
define('COMPANY_POSTCODE','731101');
...
define('ORDER_INITIAL_VALUE','1');// Initial ORDER order number (start of increment)
